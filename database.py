...
from filters import (AttributeFilter, DateFilter, DistanceFilter,
                     DiameterFilter, VelocityFilter, HazardousFilter)
...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        for approach in self._approaches:
            neo_match = self.neo_des_Dict[approach._designation]
            neo_match.approaches.append(approach)
            approach.neo = neo_match
        self._neos = self.neo_des_Dict.values()
    ...
    def get_neo_by_designation(self, designation):
        ...
        :return: The `NearEarthObject` with the desired primary designation,
                 or `None`.
        """
        if str(designation) in self.neo_des_Dict.keys():
            return self.neo_des_Dict[str(designation)]
        else:
            return None
    ...
    def get_neo_by_name(self, name):
        ...
        """
        if name in self.neo_name_Dict.keys():
