...
class AttributeFilter:
    ...
    def __repr__(self):
        """Return 'repr(self)', a computer readable string of the\
        attribute filter."""
...
class DateFilter(AttributeFilter):
    """A subclass of AttributeFilter used to get the time attribute."""

    @classmethod
    def get(cla, approach):
        """Get the time attribute of an approach in the form of a date.

        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of .time from the 'CloseApproach' in the form of
        a date, comparable to 'self.value' via 'self.op'.
        """
        return approach.time.date()


class DistanceFilter(AttributeFilter):
    """A subclass of AttributeFilter used to get the distance attribute."""
    ...
    def get(cla, approach):
        ...
        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of .distance from a 'CloseApproach', comparable to
        'self.value' via 'self.op'.
        """
...
class VelocityFilter(AttributeFilter):
    """A subclass of AttributeFilter used to get the velocity attribute."""
    ...
    def get(cla, approach):
        ...
        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of .velocity from a 'CloseApproach', comparable to
        'self.value' via 'self.op'.
        """
...
class DiameterFilter(AttributeFilter):
    """A subclass of AttributeFilter used to get the diameter attribute."""

    @classmethod
    def get(cla, approach):
        """Get the diameter attribute of an approach.

        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of .diameter from a 'CloseApproach', comparable to
        'self.value' via 'self.op'.
        """
...
class HazardousFilter(AttributeFilter):
    """A subclass of AttributeFilter used to get the hazardous attribute."""

    @classmethod
    def get(cla, approach):
        """Get the hazardous attribute of an approach.

        :param approach: A `CloseApproach` on which to evaluate this filter.
        :return: The value of .hazardous from the neo attribur of a
        'CloseApproach', comparable to 'self.value' via 'self.op'.
        """
...
def create_filters(date=None, start_date=None, end_date=None,
    ...
    represents a filter that selects close approaches whose
    nominal approach distance is at least that far away from
    ...
    """
    return (DateFilter(operator.eq, date),
...
def limit(iterator, n=None):
    ...
    """
    for count, element in enumerate(iterator):
        if n == 0 or n is None:
            yield element
        else:
            if count == n:
