...
class NearEarthObject:
    ...
    def __str__(self):
        """Return `str(self)`."""
        if self.hazardous:
            return (f"The Near Earth Object {self.fullname} has a diameter "
                    f"of {self.diameter:.3f} and IS hazardous")
        else:
            return (f"The Near Earth Object {self.fullname} has a diameter "
                    f"of {self.diameter:.3f} and is not hazardous")
    ...
    def __repr__(self):
        ...
        return (f"NearEarthObject(designation={self.designation!r}, "
                ...
                f"hazardous={self.hazardous!r}, approaches={self.approaches})")
...
class CloseApproach:
    ...
    def __str__(self):
        """Return `str(self)`."""
        return (f"A Close Approach of the Near Earth Object "
                f"{self.neo.fullname} occured at {self.time_str}, "
                f"with a distance of {self.distance:.2f} and a "
                f"velocity of {self.velocity:.2f}")

    def __repr__(self):
        """Return `repr(self)`, a computer-readable string representation\
           of this object."""
        return (f"CloseApproach(designation={self._designation!r}, "
                f"time={self.time_str!r}, distance={self.distance:.2f}, "
